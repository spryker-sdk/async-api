...
class AsyncApiMessageAttribute implements AsyncApiMessageAttributeInterface
{
    ...
    /**
     * @var \SprykerSdk\AsyncApi\AsyncApi\Message\Attributes\AsyncApiMessageAttributeCollectionInterface|string|int
     */
    protected $value;

    /**
     * @param string $name
     * @param \SprykerSdk\AsyncApi\AsyncApi\Message\Attributes\AsyncApiMessageAttributeCollectionInterface|string|int $value
     */
