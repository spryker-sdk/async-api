...
{
    /**
     * @var array<\SprykerSdk\AsyncApi\AsyncApi\Channel\AsyncApiChannelInterface>
     */
    protected array $channels;

    /**
     * @param array<\SprykerSdk\AsyncApi\AsyncApi\Channel\AsyncApiChannelInterface> $channels
     */
