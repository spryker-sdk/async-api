<?php  //[STAMP] 52286f89cea1f85b277130224d049326
...
trait AsyncApiTesterActions
{
     ...
     *
     * @return void
     * @see \SprykerSdkTest\Helper\AsyncApiValidatorHelper::haveDefaultCreatedAsyncApiFile()
     */
    public function haveDefaultCreatedAsyncApiFile(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveDefaultCreatedAsyncApiFile', func_get_args()));
    }
